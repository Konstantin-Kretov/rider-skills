...
- [xdebug_attach_to_process](tools/xdebug_attach_to_process.md) — Attach a debugger to an already-running process on the local machine by PID.
...
- [xdebug_get_process_output](tools/xdebug_get_process_output.md) — Returns captured stdout and stderr for a debug session.
